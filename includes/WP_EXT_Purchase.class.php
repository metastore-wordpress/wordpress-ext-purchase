...
class WP_EXT_Purchase {
	...
	public function __construct() {
		// Settings.
		$this->pt_ID      = 'purchase';
		$this->archive_ID = 'purchases';
		$this->domain_ID  = 'purchase';
		$this->cap_type   = [ 'pt_purchase', 'pt_purchases' ];
 ...
 *
 * @return WP_EXT_Purchase
 */
function WP_EXT_Purchase() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Purchase;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Purchase(), 'run' ] );
