...
/**
 * Class WP_EXT_Purchase_Post_Type
 */
class WP_EXT_Purchase_Post_Type extends WP_EXT_Purchase {
	...
	public function post_type() {
		$labels  = [
			'name'                  => _x( 'Purchases', 'Purchase General Name', 'wp-ext-' . $this->domain_ID ),
			'singular_name'         => _x( 'Purchase', 'Purchase Singular Name', 'wp-ext-' . $this->domain_ID ),
			'menu_name'             => __( 'Purchases', 'wp-ext-' . $this->domain_ID ),
			'name_admin_bar'        => __( 'Purchase', 'wp-ext-' . $this->domain_ID ),
		...
		$args    = [
			'label'               => __( 'Purchase', 'wp-ext-' . $this->domain_ID ),
			'description'         => __( 'Purchase Description', 'wp-ext-' . $this->domain_ID ),
			'labels'              => $labels,
 ...
 *
 * @return WP_EXT_Purchase_Post_Type
 */
function WP_EXT_Purchase_Post_Type() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Purchase_Post_Type;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Purchase_Post_Type(), 'run' ] );
