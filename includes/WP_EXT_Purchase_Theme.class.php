...
/**
 * Class WP_EXT_Purchase_Theme
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Purchase_Theme extends WP_EXT_Purchase {
 ...
 *
 * @return WP_EXT_Purchase_Theme
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Purchase_Theme() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Purchase_Theme;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Purchase_Theme(), 'run' ] );
